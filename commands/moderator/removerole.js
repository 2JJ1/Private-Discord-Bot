...
module.exports = {
	...
	async execute(interaction){
		try{
			...
			if(!settings.modCommands.addRoleWhitelist.find(e => e === role.name)) throw "That role is not whitelisted as removable"

			//Apply the role
			await target.roles.remove(role, `Removed by <@${interaction.author.id}>`)
